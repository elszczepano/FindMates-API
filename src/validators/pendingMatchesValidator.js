...
exports.validateCreate = [
    ...
    check('user1Approval').optional().trim().isBoolean().withMessage('First user approval must be a boolean.'),
    check('user2Approval').optional().trim().isBoolean().withMessage('Second user approval must be a boolean.'),
    sanitizeBody('*').escape()
];
